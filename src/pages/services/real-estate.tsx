...
export default function RealEstateConsulting() {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center lg:text-left grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:grid grid-cols-2 gap-4">
            <div className="bg-slate-800/40 rounded-xl border border-gray-800 p-6 shadow-lg">
              ...
              <h3 className="text-gray-450 text-xs font-semibold uppercase tracking-wider mb-1">Response Time</h3>
              <span className="text-lg font-bold text-white block">Within 24 Hours</span>
            </div>
            <div className="bg-slate-800/40 rounded-xl border border-gray-800 p-6 shadow-lg">
              <Building className="h-8 w-8 text-indigo-400 mb-3" />
              <h3 className="text-gray-450 text-xs font-semibold uppercase tracking-wider mb-1">Pre-Vetted Assets</h3>
      ...
      <section id="property-types" className="py-24 bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {propertyTypes.map((prop, idx) => (
              <div key={idx} className="bg-white rounded-2xl border border-gray-150 p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">{prop.name}</h3>
