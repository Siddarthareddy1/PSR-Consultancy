  ...
  return (
    <>
      ...
      <section className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4 bg-gray-50">
        ...
        <p className="text-gray-650 font-body text-sm sm:text-base max-w-md mb-2 leading-relaxed">
          Your information has been securely received by our database.
        </p>
        <p className="text-gray-450 text-xs sm:text-sm max-w-sm mb-8 leading-relaxed">
          A senior advisor will contact you within the next 2 hours via your preferred contact method.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 rounded-lg text-sm font-bold text-slate-800 bg-white border border-gray-200 hover:bg-gray-50 transition-colors shadow-sm"
          >
            Back to Home
          </Link>
          <Link
