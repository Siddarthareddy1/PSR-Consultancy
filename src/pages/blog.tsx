  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-950 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center z-10 fade-in">
          ...
          <h1 className="text-4xl font-display font-extrabold mb-4 leading-tight text-white">
      ...
      <section className="py-6 bg-white border-b border-gray-150 sticky top-[72px] z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="relative w-full md:w-80">
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 text-xs focus:outline-none focus:border-primary transition-colors text-gray-800 bg-gray-50"
            />
          ...
          {filteredPosts.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.map((post: BlogPost) => (
                <article
                  key={post.slug}
                  className="bg-white rounded-2xl border border-gray-150 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col h-full card-hover"
                >
                  <div className="p-6 sm:p-8 flex flex-col h-full justify-between">
                    <div>
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 font-heading leading-snug">
                    ...
                    <div className="border-t border-gray-100 pt-6 mt-4 flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="h-9 w-9 rounded-full bg-gray-100 text-primary flex items-center justify-center font-bold text-xs shadow-sm">
                      ...
                      <Link
                        href={`/blog/${post.slug}`}
                        className="p-2 rounded-lg bg-gray-50 hover:bg-primary hover:text-white transition-all text-gray-700 shadow-sm"
                      >
            ...
            <div className="text-center py-20 bg-white rounded-2xl border border-gray-150 max-w-lg mx-auto shadow-sm">
