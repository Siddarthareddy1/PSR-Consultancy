      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 text-gray-650 text-sm sm:text-base leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-gray-900 font-heading mt-8">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-gray-900 font-heading mt-8">2. How We Use Your Information</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 font-heading mt-8">3. Data Retention and Sharing</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-gray-900 font-heading mt-8">4. Cookies and Analytics</h2>
            <p>
